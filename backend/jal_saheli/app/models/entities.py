...
class AnalysisResult(Base):
    ...
    provider: Mapped[str] = mapped_column(String(80), default="VedGeoAI-RF-Lookup")
    ...
    ndvi_source: Mapped[str] = mapped_column(String(40), default="unknown")
    ndwi_source: Mapped[str] = mapped_column(String(40), default="unknown")
